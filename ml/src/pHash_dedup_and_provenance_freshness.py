...
try:
    from .config import (
        RAW_FRESHNESS_DIR as RAW_SPECIES_DIR,
        PROCESSED_FRESHNESS_DIR as PROCESSED_SPECIES_DIR,
        FRESHNESS_TRAIN_DIR as SPECIES_TRAIN_DIR,
        FRESHNESS_VAL_DIR as SPECIES_VAL_DIR,
        FRESHNESS_TEST_DIR as SPECIES_TEST_DIR,
        REPORTS_DIR,
        SPLIT_RATIOS,
        RANDOM_SEED
    )
